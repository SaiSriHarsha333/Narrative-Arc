...
import os
import pickle
from data_loader_embedings import get_loader
...
def main(args):
    ...
    data_loader = get_loader(args.image_dir, args.caption_path,
                                args.dictionary, emb_model, args.batch_size,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='collections_all_science_out/allcontent_required_NotNull_sum_outFastText.ckpt' , help='path for saving trained models')
    ...
    parser.add_argument('--dictionary', type=str, default='collections_all_science_out/allcontent_required_NotNull_sum_out.dict', help='path to dictionary file')
    ##parser.add_argument('--caption_path', type=str, default='data/annotations/captions_train2014.json', help='path for train annotation json file')
    parser.add_argument('--caption_path', type=str, default='collections_all_science_out/test.csv', help='path for train annotation json file')
