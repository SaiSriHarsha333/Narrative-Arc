...
from model_embeddings import EncoderCNN, DecoderRNN
...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        for i, (array, emb_captions, captions, lengths) in enumerate(data_loader):
            ...
            outputs = decoder(array, emb_captions, lengths)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--caption_path', type=str, default='collections_all_science_out.csv', help='path for train annotation json file')
