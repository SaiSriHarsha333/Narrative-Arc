...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='decoder-50-150CBSE.ckpt' , help='path of saved models')
    parser.add_argument('--vocab_path', type=str, default='Cbse_science.pkl', help='path for vocabulary wrapper')
    parser.add_argument('--dictionary', type=str, default='Cbse_science.dict', help='path to dictionary file')
    parser.add_argument('--caption_path', type=str, default='Cbse_science.csv', help='path for train annotation json file')
